...
const replaceQuotesFromData = str => str.replace(/'/g, '"');
...
window.addEventListener('load', () => {
    ...
    const lucid_model = new LycidChartModel(lucid_container);

    const lucid_parseData = element => {
        const elementData = replaceQuotesFromData(element.getAttribute('xlink:href'));
